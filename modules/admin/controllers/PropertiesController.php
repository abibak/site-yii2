...
use app\modules\admin\models\ProductsPropertiesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PropertiesController implements the CRUD actions for ProductProperties model.
 */
class PropertiesController extends Controller
{
    ...
    {
        $searchModel = new ProductsPropertiesSearch();
